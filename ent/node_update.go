...
func (nu *NodeUpdate) SetNetworkID(id int) *NodeUpdate {
	nu.mutation.SetNetworkID(id)
	return nu
}

// SetNillableNetworkID sets the "network" edge to the Network entity by ID if the given value is not nil.
func (nu *NodeUpdate) SetNillableNetworkID(id *int) *NodeUpdate {
	if id != nil {
		nu = nu.SetNetworkID(*id)
	}
	return nu
}

// SetNetwork sets the "network" edge to the Network entity.
func (nu *NodeUpdate) SetNetwork(n *Network) *NodeUpdate {
	return nu.SetNetworkID(n.ID)
}
...
func (nu *NodeUpdate) ClearNetwork() *NodeUpdate {
	nu.mutation.ClearNetwork()
	return nu
}
...
func (nu *NodeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nu.mutation.NetworkCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   node.NetworkTable,
			Columns: []string{node.NetworkColumn},
			Bidi:    false,
	...
	if nodes := nu.mutation.NetworkIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   node.NetworkTable,
...
// SetNetworkID sets the "network" edge to the Network entity by ID.
func (nuo *NodeUpdateOne) SetNetworkID(id int) *NodeUpdateOne {
	nuo.mutation.SetNetworkID(id)
	return nuo
}

// SetNillableNetworkID sets the "network" edge to the Network entity by ID if the given value is not nil.
func (nuo *NodeUpdateOne) SetNillableNetworkID(id *int) *NodeUpdateOne {
	if id != nil {
		nuo = nuo.SetNetworkID(*id)
	}
	return nuo
}

// SetNetwork sets the "network" edge to the Network entity.
func (nuo *NodeUpdateOne) SetNetwork(n *Network) *NodeUpdateOne {
	return nuo.SetNetworkID(n.ID)
}
...
// ClearNetwork clears the "network" edge to the Network entity.
func (nuo *NodeUpdateOne) ClearNetwork() *NodeUpdateOne {
	nuo.mutation.ClearNetwork()
	return nuo
}
...
func (nuo *NodeUpdateOne) sqlSave(ctx context.Context) (_node *Node, err error) {
	...
	if nuo.mutation.NetworkCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   node.NetworkTable,
	...
	if nodes := nuo.mutation.NetworkIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   node.NetworkTable,
