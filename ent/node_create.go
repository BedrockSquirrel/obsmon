...
func (nc *NodeCreate) SetNetworkID(id int) *NodeCreate {
	nc.mutation.SetNetworkID(id)
	return nc
}

// SetNillableNetworkID sets the "network" edge to the Network entity by ID if the given value is not nil.
func (nc *NodeCreate) SetNillableNetworkID(id *int) *NodeCreate {
	if id != nil {
		nc = nc.SetNetworkID(*id)
	}
	return nc
}

// SetNetwork sets the "network" edge to the Network entity.
func (nc *NodeCreate) SetNetwork(n *Network) *NodeCreate {
	return nc.SetNetworkID(n.ID)
}
...
func (nc *NodeCreate) createSpec() (*Node, *sqlgraph.CreateSpec) {
	...
	if nodes := nc.mutation.NetworkIDs(); len(nodes) > 0 {
